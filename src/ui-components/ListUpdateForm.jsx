...
export default function ListUpdateForm(props) {
  ...
  const [listRecord, setListRecord] = React.useState(list);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp ? await DataStore.query(List, idProp) : list;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            List.copyOf(listRecord, (updated) => {
